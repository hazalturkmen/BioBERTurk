...
To evaluate our model’s performance at the clinical text classification task, we created a dataset using an in-house corpus.The final dataset had 3749 reports, 59,157 sentences and 764,848 words.T
